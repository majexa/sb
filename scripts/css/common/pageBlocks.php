...
if (!$d and !($d = $_GET)) throw new Exception("\$d not defined");
if (!isset($d['colsN'])) throw new Exception("\$d['colsN'] not defined");
...
if ($colsN > $maxCols or $colsN < $minCols) throw new Exception("wrong cols number. Min: $minCols, Max: $maxCols");
