<? //$this->tpl('admin/modules/pages/gray-header', $d) ?>
<? $this->tpl('admin/modules/pageBlocks/header', $d) ?>
...
for ($colN=1; $colN <= $d['colsNumber']; $colN++) {
  ...
  if ($col['allowBlocks'])
    print '<div class="iconsSet"><a href="'.$this->getPath(3).'/newBlock/'.$colN.'" class="add"><i></i> Создать блок</a></div>';
