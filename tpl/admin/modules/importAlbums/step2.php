...
<? foreach ($d['dirs'] as $k => $v) { ?>
  <div class="item">
    <div class="smIcons bordered"><a href="<?= $this->getPath(3) ?>?a=deleteFolder&n=<?= $k ?>" class="delete"><i></i></a></div>
    <?= $v['title'] ?>
...
<input type="submit" value="← Вернуться к шагу 1" onclick="window.location='<?= $this->getPath(3) ?>'" />
