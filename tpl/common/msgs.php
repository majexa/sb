...
<? if (1 or Auth::check() or $d['anonym']) { ?>
  ...
  <? if (Auth::check()) { ?>
    <? if ($d['subscribed']) { ?>
      ...
      <a href="<?= $this->getPath() ?>?a=sub_unsubscribe">Отписаться?</a></p>
    <? } else { ?>
      <p class="info">Вы можете <a href="<?= $this->getPath() ?>?a=sub_subscribe">подписаться</a> на уведомления
  ...
  */ ?>
  ...
  <form action="<?= $this->getPath() ?>" method="POST" id="msgForm">
    ...
    <div class="iconsSet bordered">
      ...
      <? } ?>
      <!-- <a href="<?= $this->getPath() ?>?a=sub_iiUpload" class="file" onclick="openwin(this.href, 280, 110); return false;" title="Загрузить картинку или файли"><i></i></a> -->
      <div class="clear"><!-- --></div>
    </div>
